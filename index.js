...
function annoyingSong(bottleNum){
  while(bottleNum >= 0 ){
    ...
    console.log( bottleNum +" bottles of soda on the wall," +bottleNum +" bottles of soda, take one down pass it around " +bottleNum +" bottles of soda on the wall")
    bottleNum--;
  }
}
